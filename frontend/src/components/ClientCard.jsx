    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                    <h3 className="text-[15px] font-semibold text-gray-800">{client.name}</h3>
                    <p className="text-xs text-gray-500">{client.ordersCount} zleceń</p>
                </div>
            </div>
            ...
            <div className="mt-auto pt-4 border-t border-gray-100 text-[13px] text-gray-500">
                Rowerów zarejestrowanych: {client.bikesCount}
            </div>
        </div>
    )
}