        ...
        >
            <div className="flex items-center gap-4 mb-5 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                    <h3 className="text-[15px] font-semibold text-gray-800 truncate">{fullName}</h3>
                    <p className="text-xs text-gray-500">{client.repair_orders_count || 0} zleceń</p>
                </div>
            </div>

            <div className="space-y-2.5 mb-6 min-w-0">
                <div className="flex items-center text-sm text-gray-600 gap-3 min-w-0">
                    ...
                    <span className="truncate">{client.email || "Brak e-maila"}</span>
                </div>
                <div className="flex items-center text-sm text-gray-600 gap-3 min-w-0">
                    <svg className="w-4 h-4 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                    <span className="truncate">{client.phone || "Brak telefonu"}</span>
                </div>
            </div>
